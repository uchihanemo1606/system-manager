import{b as d,r as c,d as m,u as l}from"./domain-C2mOs3WS.js";import{s as r}from"./toast-DwbAm--J.js";import"./api_config-C1dH2VF8.js";function g(t,s){const e=document.querySelector("#hardware-list tbody");if(e.innerHTML="",!t||t.length===0){e.innerHTML='<tr><td class="text-center text-muted">Chưa có phần cứng nào sử dụng tên miền này.</td></tr>';return}t.forEach(n=>{const i=document.createElement("tr");i.innerHTML=`
            <td>
