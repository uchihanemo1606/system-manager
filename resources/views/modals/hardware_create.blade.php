        ...
        <div class="col-md-6">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <button type="button" id="btn-create-dbname" class="btn btn-outline-secondary"
                    onclick="openCreateModal('dbname', {}, async () => await populateDropdowns())" title="Tạo tên CSDL">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="d-flex gap-2 align-items-start">
                ...
                <button type="button" id="btn-create-osname" class="btn btn-outline-secondary"
                    onclick="openCreateModal('OS', {}, async () => await populateDropdowns())" title="Tạo tên OS">
                    <i class="mdi mdi-plus"></i>
                </button>
...
<div class="modal fade " style="background-color: rgba(0, 0, 0, 0.6);" id="hardware-data-modal" tabindex="-1"
