<div class="card  shadow-sm m-0">
    <div class="card-body d-flex flex-column" style="max-height: 92vh; overflow: hidden;">
        <h4 class="card-title text-primary ">
            <i class="mdi mdi-account-key mr-2 text-info"></i> Sửa Vai Trò
        </h4>
        <form id="edit-user-role-form" class="d-flex flex-column" style="flex-grow: 1; overflow: hidden;">
            <!-- Tên Role -->
            <div class="form-group mb-2">
                <label for="role-name" class="font-weight-bold text-dark">
                    <i class="mdi mdi-shield-account text-info mr-2"></i> Bạn đang sửa vai trò của người dùng:
                </label>
                <input type="text" id="username" class="form-control font-weight-bold" readonly>
            </div>
            ...
            <div class="d-flex flex-column" style="flex-grow: 1; overflow: hidden;">
                ...
                <div class="">
                    <div class="d-flex justify-content-between align-items-center ">
                        <h5 class="text-primary border-bottom pb-2 mb-0">Danh sách Vai trò</h5>
                ...
                <!-- Danh sách quyền -->
                <div class="overflow-auto border rounded" id="role-checkboxes"
            ...
            <div class="modal-footer p-0" style="flex-shrink: 0;">
                <button type="submit" class="btn btn-primary btn-lg w-100 shadow-sm">
                    <i class="mdi mdi-check-circle-outline mr-1"></i> Sửa vai trò
                </button>
            </div>
        </form>
    </div>
