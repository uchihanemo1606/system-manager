                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="text-primary">
                                        ...
                                        <input type="text" id="hardware-ip-input"
                                ...
                                <div class="col-4">
                                    <div class="text-primary">
                                        ...
                                        <input type="text" id="hardware-os-input"
                                            class="form-control form-control-sm d-none">
                                    </div>
                                </div>
                                <div class="col-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-3">
                                            <h6 class="text-primary mb-0 d-flex align-items-center">
                                                ...
                                                <button class="btn btn-outline-primary btn-sm mr-3" id="add-hardware-domain-btn"
                                                    type="button">
                                                    <i class="mdi mdi-plus-circle-outline mr-1"></i> Thêm tên miền
                                                </button>
                                                <button class="btn btn-outline-primary btn-sm" id="view-domain-btn"
                                                    type="button">
                                                    Xem tên miền <i class="mdi mdi-arrow-right ml-1"></i>
                                                </button>
                                            </h6>
                                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" id="hardware-hdd-input"
                                                    class="form-control form-control-sm d-none">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" id="hardware-ram-input"
                                                    class="form-control form-control-sm d-none">
                                            </td>
                                        </tr>
                                        <tr>
