            ...
            <div class="row">
                <div class="page-title-box col-12 d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('hardware.create')
                        <a href="#" class="btn btn-primary" onclick="loadModal('hardware_create')">Thêm phần cứng</a>
                    @endhasPermission
                </div>
            </div> 
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            <input type="text" id="filter-dbname" class="form-control" placeholder="Tên Database">
                        </div>
                        <div class="col-md-3 mb-2">
                            <input type="text" id="filter-dbversion" class="form-control" placeholder="Phiên bản Database">
                        </div>
                        <div class="col-md-3 mb-2">
                    ...
                    <div id="advanced-filters" style="display: none;">
                        <div class="row">
                            <div class="col-md-3 mb-2">
                                <input type="text" id="filter-os" class="form-control" placeholder="Hệ điều hành">
                            </div>
                            <div class="col-md-3 mb-2">
                                <input type="text" id="filter-osver" class="form-control" placeholder="Phiên bản HĐH">
                            </div>
                            <div class="col-md-3 mb-2">
